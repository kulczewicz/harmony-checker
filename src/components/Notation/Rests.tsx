...
export function QuarterRest(props: SvgPropsThemeUi) {
  return (
    <svg height="28px" viewBox="1 -373 269 748" {...props}>
      <path
        transform="scale(1, -1)"
...
export function EighthRest(props: SvgPropsThemeUi) {
  return (
    <svg height="16px" viewBox="0 -174 247 425" {...props}>
      <path
        transform="scale(1, -1)"
...
export function SixteenthRest(props: SvgPropsThemeUi) {
  return (
    <svg height="24px" viewBox="0 -180 320 679" {...props}>
      <path
        transform="scale(1, -1)"
...
export function ThirtySecondRest(props: SvgPropsThemeUi) {
  return (
    <svg height="32px" viewBox="0 -426 363 926" {...props}>
      <path
        transform="scale(1, -1)"
