export function FullHalfRest() {
  return (
    <svg height="5px" viewBox="0 -135 282 144">
      <path d="M282 -109c0 -14 -12 -26 -26 -26h-230c-15 0 -26 12 -26 26v92c0 15 11 26 26 26h230c14 0 26 -11 26 -26v-92z" />
    </svg>
  );
}

export function QuarterRest() {
  return (
    <svg height="28px" viewBox="1 -373 269 748">
      <path
        transform="scale(1, -1)"
...
export function EighthRest() {
  return (
    <svg height="16px" viewBox="0 -174 247 425">
      <path
        transform="scale(1, -1)"
...
export function SixteenthRest() {
  return (
    <svg height="24px" viewBox="0 -180 320 679">
      <path
        transform="scale(1, -1)"
...
export function ThirtySecondRest() {
  return (
    <svg height="32px" viewBox="0 -426 363 926">
      <path
        transform="scale(1, -1)"
